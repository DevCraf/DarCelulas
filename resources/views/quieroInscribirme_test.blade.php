          ...
          <div id="home-content-1" class="col home-content no-view">
            <div class="row align-items-center">
              <div class="col-6">
                ...
                <p>Registrarte como donante es una decisión muy importante, queremos saber que estás totalmente seguro, si es así por favor confirmalo en el formulario.</p>
                <img class="fluid-img" src="{!! asset('img/conoce_el_registro/imagen_preinscripcion.png') !!}" alt="DarCelulas">
              </div>
              <!-- Formulario -->
                ...
                <form class="form-horizontal form-inscripcion" action="{!! route('postNewDonor') !!}" method="post">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-12 col-md-6">
                      <div class="lineb">
                        <input type="text" name="name" value="{{ old('name') }}" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Primer nombre*" required>
                    ...
                    <div class="col-sm-12 col-md-6">
                      <div class="lineb">
                        <input type="text" name="second_name" value="{{ old('second_name') }}" class="form-control" placeholder="Segundo nombre">
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-6">
                      <div class="lineb">
                        <input type="text" name="surname" value="{{ old('surname') }}" class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" placeholder="Primer apellido*" required>
                    ...
                    <div class="col-sm-12 col-md-6">
                      <div class="lineb">
                        <input type="text" name="second_surname" value="{{ old('second_surname') }}" class="form-control" placeholder="Segundo apellido">
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    <div class="col-12">
                      <div class="lineb">
                        <div class="row">
                          <label for="gender" class="col-6 control-label">Género<i class="red">*</i></label>
                          <div class="col-sm-6">
                  ...
                  <div class="form-group row">
                    <div class="col-12">
                      <div class="lineb">
                        <div class="row">
                          <label for="birthday" class="col-6 control-label">Fecha de nacimiento<i class="red">*</i></label>
                          <div class="col-6">
                            <input type="date" name="birthday" value="{{ old('birthday') }}" class="form-control{{ $errors->has('birthday') ? ' is-invalid' : '' }}" required>
                  ...
                  <div class="form-group row">
                    <div class="col-12">
                      <div class="lineb">
                        <div class="row">
                          <label for="document" class="col-5 control-label">Identificación<i class="red">*</i></label>
                          <div class="col-sm-3">
                          ...
                          <div class="col-sm-4">
                            <input type="text" name="document" value="{{ old('document') }}" class="form-control{{ $errors->has('document') ? ' is-invalid' : '' }}" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <div class="lineb">
                        <input type="text" name="phone" value="{{ old('phone') }}" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="Teléfono*" required>
                  ...
                  <div class="form-group row">
                    <div class="col-12">
                      <div class="lineb">
                        <div class="row">
                          <label for="como_conocio" class="col-6 control-label">¿Cómo te enteraste?</label>
                          <div class="col-sm-6">
                            <select class="form-control{{ $errors->has('como_conocio') ? ' is-invalid' : '' }}" name="como_conocio">
                              <option value="">Seleccione</option>
                              ...
                              <option value="Referencia de un conocido">Referencia de un conocido</option>
                              <option value="Pendón, folleto o tarjeta">Pendón, folleto o tarjeta</option>
                              <option value="Información de otros registros">Información de otros registros</option>
                              <option value="Televisión, periódicos o radio">Televisión, periódicos o radio</option>
                              @if(old('como_conocio'))
                                <option value="{{ old('como_conocio') }}" selected>{{ old('como_conocio') }}</option>
                              @endif
                            </select>
                  ...
                  <div class="form-group row">
                      <div class="col-12">
                          <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="uso_datos" id="uso_datos" {{ old('uso_datos') ? 'checked' : '' }} required>
    ...
    <div class="col-12">
      ...
      <div id="fondo_general_m" class="row align-items-center">
        <div class="col-12 text-center pt-3">
          <h2 class="mb-3">¡Quiero preinscribirme!</h2>
          <p>Registrarte como donante es una decisión muy importante, queremos saber que estás totalmente seguro, si es así por favor confirmalo en el formulario.</p>
          <img class="img-fluid" src="{!! asset('img/conoce_el_registro/imagen_preinscripcion.png') !!}" alt="DarCelulas">
        </div>
        <div class="col-12 pb-3">
          <form class="form-horizontal form-inscripcion" action="{!! route('postNewDonor') !!}" method="post">
            ...
            <div class="form-group row">
              <div class="col-12">
                <div class="lineb">
                  <input type="text" name="name" value="{{ old('name') }}" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Primer nombre*">
            ...
            <div class="form-group row">
              ...
              <div class="col-12">
                <div class="lineb">
                  <input type="text" name="surname" value="{{ old('surname') }}" class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" placeholder="Primer apellido*">
