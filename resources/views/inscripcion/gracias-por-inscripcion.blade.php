          ...
          <div class="col home-content">
            <div class="row">
              <div class="col-12 text-center">
                <img class="img-fluid mb-3 mt-movil" src="{!! asset('img/gracias-respuesta.png') !!}" alt="Gracias por su inscripción en DarCélulas">
              </div>
              <div class="col-12">
                <ul class="lista-gracias">
                  ...
                  <li>
                    <p>Tu inscripción quedó programada para:</p>
                    <p class="mb-0"><b>Fecha:</b> {{ $inscripcion->fecha_inscripcion }}</p>
                    <p class="mb-0"><b>Jornada:</b>  {{ $inscripcion->jornada }}</p>
                    <p class="mb-0"><b>Lugar:</b> Banco Distrital de Sangre - IDCBIS, Carrera 32 # 12 - 81 Edificio IDCBIS</p>
                  </li>
                </ul>
              </div>
            </div>
