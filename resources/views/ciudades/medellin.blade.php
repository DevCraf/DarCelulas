            ...
            <div class="row">
                <article>
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-5">
                                <img class="img-fluid my-5" src="{!! asset('img/ciudades/completado-medellin-04.png') !!}" alt="">
                            </div>
                            <div class="col-md-7 justify-content-center text-center">
                                ...
                                <button><strong>Para poder hacerlo por favor escoge uno de los métodos disponibles en la
                                        ciudad de Medellin.</strong><br>
                                    <p>Te sugerimos leer la información de cada uno antes de iniciar el proceso</p>
                                </button>
                                <div class="card col align-self-center">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Entrega de kit de inscripción en <a href="{!! route ('buzonesAutorizados') !!}">buzones autorizados
                                                        <span>(Clic)</span></a></strong></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong>Entrega de kit de inscripción a <a href="{!! route ('entregaKitDomicilio') !!}">domicilio
                                                        <span>(Clic)</span></a></strong></p>
                                        </div>
                                    </div>
                                </div>
